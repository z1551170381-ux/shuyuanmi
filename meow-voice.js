...
` : ' ';
  ...
  function _bgmDockPeek(root) {
    if (!root) return 84;
    // 收起时不要藏得太深，至少保证半张唱片和一个展开侧边按钮可见
    if (root.classList.contains('mini')) return 66;
    if (root.classList.contains('compact')) return 74;
    return 84;
  }
  ...
  function _getBgmDock() {
    ...
    root.innerHTML = `
      <div class="mv-bgm-shell">
        ...
        <button type="button" class="mv-bgm-edge-tab" title="展开播放器" aria-label="展开播放器"><span class="mv-bgm-edge-tab-icon">♫</span><span class="mv-bgm-edge-tab-arrow">‹</span></button>
    ...
    style.textContent = `
      #meow-voice-bgm-dock{font-family:inherit;color:#26353a;overflow:visible;--mv-bgm-peek:84px}
      #meow-voice-bgm-dock .mv-bgm-shell{position:relative;min-height:114px;padding-left:42px}
      #meow-voice-bgm-dock .mv-bgm-edge-tab{position:absolute;left:54px;top:38px;display:flex;align-items:center;gap:4px;height:30px;padding:0 10px 0 8px;border:0;border-radius:999px;background:linear-gradient(180deg, rgba(255,255,255,.88), rgba(243,243,239,.72));box-shadow:0 10px 24px rgba(20,35,40,.12);color:#56656d;cursor:pointer;z-index:7;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);transition:opacity .18s ease,transform .18s ease}
      #meow-voice-bgm-dock .mv-bgm-edge-tab:hover{transform:translateX(-1px)}
      #meow-voice-bgm-dock .mv-bgm-edge-tab-icon{font-size:12px;line-height:1;opacity:.9}
      #meow-voice-bgm-dock .mv-bgm-edge-tab-arrow{font-size:16px;line-height:1;opacity:.7;margin-top:-1px}
      ...
      #meow-voice-bgm-dock.collapsed .mv-bgm-edge-tab{opacity:1;pointer-events:auto}
      #meow-voice-bgm-dock:not(.collapsed) .mv-bgm-edge-tab{opacity:0;pointer-events:none;transform:translateX(8px)}
      #meow-voice-bgm-dock.compact{width:244px !important;--mv-bgm-peek:74px}
      ...
      #meow-voice-bgm-dock.mini{width:174px !important;max-width:calc(100vw - 2px) !important;--mv-bgm-peek:66px}
      #meow-voice-bgm-dock.mini .mv-bgm-shell{padding-left:18px;min-height:74px}
      #meow-voice-bgm-dock.mini .mv-bgm-edge-tab{left:42px;top:26px;height:24px;padding:0 8px 0 7px;gap:3px}
      #meow-voice-bgm-dock.mini .mv-bgm-edge-tab-icon{font-size:10px}
      #meow-voice-bgm-dock.mini .mv-bgm-edge-tab-arrow{font-size:13px}
      ...
      @media (max-width: 640px){
        #meow-voice-bgm-dock{width:234px !important;max-width:calc(100vw - 4px) !important;--mv-bgm-peek:72px}
        #meow-voice-bgm-dock .mv-bgm-shell{padding-left:28px;min-height:88px}
        #meow-voice-bgm-dock .mv-bgm-edge-tab{left:48px;top:30px;height:26px;padding:0 8px 0 7px;gap:3px}
    ...
    root.addEventListener('click', async (e) => {
      ...
      if (e.target.closest('.mv-bgm-disc-hit') || e.target.closest('.mv-bgm-edge-tab')) {
