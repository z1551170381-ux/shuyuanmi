...
#${ID}[data-theme="frost"][data-view="home"]{
  --ph-glass:        rgba(255,252,246,var(--phHomeA));
  --ph-glass-strong: rgba(255,252,246,var(--phHomeStrongA));
  --ph-glass-border: rgba(210,200,185,var(--phHomeBorderA));
}
#${ID}[data-theme="frost"][data-view="app"]{
  --ph-glass:        rgba(255,252,246,var(--phAppA));
  --ph-glass-strong: rgba(255,252,246,var(--phAppStrongA));
  --ph-glass-border: rgba(210,200,185,var(--phAppBorderA));
}
...
#${ID}[data-theme="frost"]{
  /* 底色：#f5f2ee 暖奶白，对标 Nube/Auro 参考图 */
  --ph-bg-primary: linear-gradient(160deg,#f9f7f4 0%,#f5f2ee 50%,#ede9e4 100%);
  --ph-glass: rgba(255,253,250,.68);
  --ph-glass-strong: rgba(255,253,250,.85);
  --ph-glass-border: rgba(210,200,185,.45);
  --ph-glass-blur: 28px;
  --ph-text: rgba(28,22,16,.88);
  --ph-text-sub: rgba(28,22,16,.50);
  --ph-text-dim: rgba(28,22,16,.28);
  /* 强调色：莫兰迪鼠尾草绿（可被 accentHex 覆盖） */
  --ph-accent: #7d9b8a;
  --ph-accent2: #a3bab0;
  --ph-accent-grad: linear-gradient(135deg,#7d9b8a,#a3bab0);
  --ph-shadow: rgba(80,60,40,.09);
  --ph-sep: rgba(28,22,16,.055);
  --ph-row-bg: rgba(255,253,250,.72);
  --ph-row-hover: rgba(255,253,250,.92);
  --ph-input-bg: rgba(255,253,250,.88);
  --ph-input-border: rgba(28,22,16,.10);
  --ph-send-btn: #7d9b8a;
  --ph-send-icon: #fff;
  ...
  --ph-tabbar-bg: rgba(250,248,244,.92);
  --ph-tabbar-border: rgba(28,22,16,.06);
  --ph-tabbar-on: #7d9b8a;
  --ph-tabbar-off: rgba(28,22,16,.38);
  --ph-appbar-bg: rgba(249,247,243,.94);
  --ph-appbody-bg: rgba(246,243,239,.97);
  --ph-topbar-bg: rgba(250,248,244,.94);
  --ph-topbar-border: rgba(28,22,16,.055);
  --ph-topbar-title: rgba(28,22,16,.88);
  --ph-topbar-btn: rgba(28,22,16,.44);
  --ph-sticker-bg: rgba(246,243,239,.97);
  --ph-input-area-bg: rgba(249,247,243,.96);
  ...
  --ph-wechat-bg: rgba(232,228,222,.85);
  --ph-plus-popup-bg: rgba(52,46,38,.90);
  --ph-modal-bg: rgba(254,252,249,.98);
  --ph-modal-text: rgba(28,22,16,.88);
  --ph-confirm-bg: #fefcf9;
